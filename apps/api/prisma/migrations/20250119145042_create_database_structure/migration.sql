...
CREATE TABLE "projcets" (
    ...
    CONSTRAINT "projcets_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "projcets_slug_key" ON "projcets"("slug");
...
-- AddForeignKey
ALTER TABLE "projcets" ADD CONSTRAINT "projcets_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "projcets" ADD CONSTRAINT "projcets_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
